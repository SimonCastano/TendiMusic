...
<section class="contenido">	
  <form class="col s12" action="responder.php" method="post">
    ...
    <center> <button  class="btn waves-effect waves-light  #b71c1c red darken-4" type="submit" name="enviar">enviar
...
$desde="CASTANOSIMON2002@gmail.com";
$Mensaje=$_POST['com'];
  ...
  <div class="container #b71c1c red darken-4">
    <div class="row">
      <div class="footer-copyright">
        <div class="container">
          <mare> © 2017 Copyright  simón castaño-scr_simon </mare>
        </div>
      </div>
    </footer> 
    </html>
